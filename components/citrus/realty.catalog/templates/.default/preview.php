...
$arParams['DETAIL_PROPERTY_CODE'][] = 'draft_for';

// FIX clear cache for element SEO
$ipropValues = new InheritedProperty\ElementValues($arParams['IBLOCK_ID'], $arResult['VARIABLES']['ELEMENT_ID']);
